import { UI_WIDTH, UI_HEIGHT, PROPERTY_ROW_HEIGHT } from './constants/layout'
import { ComponentNode, ComponentContentProperty } from './constants/types'
...
figma.ui.onmessage = msg => {
  ...
  if (msg.type === 'delete-content-property') {
    const newContentProps: ComponentContentProperty[] = JSON.parse(selectedComponent.getPluginData('contentProps')).filter(props => {
